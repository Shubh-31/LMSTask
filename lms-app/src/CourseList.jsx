...
const CourseList = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10">
      ...
      <h4 className="text-xl font-bold text-center text-gray-600 mb-8">
        Learning Made Easy
      </h4>
        ...
        {courses.map((course) => {
          ...
          return (
            <div key={course.id} className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition">
              ...
              <button
                className="mt-4 w-full bg-blue-500 text-gray px-4 py-2 rounded-lg hover:bg-blue-600 transition cursor-pointer font-semibold"
